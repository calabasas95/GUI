...
public class Bai4_7 extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == tinh) {
			...
			if (a!=0) txtkq.setText(Float.toString((float)-b/a));
				...
				if (b==0) txtkq.setText("PT co VSN");
				else txtkq.setText("PTVN");
			}
		}
	...
	public Bai4_7(String st) {
		super(st);
		GUI();
	}
	public static void main(String[] args) {
		new Bai4_7("Giai phuong trinh bac 1");
	}
}
